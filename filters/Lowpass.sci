...
function [output, wfm, fr] = Lowpass(input, samplingRate, cutoffFreq, stopBandAttenuation, transitionBand)
...
// フィルタ生成＆適用(窓関数法)
[wft, wfm, fr] = wfir('lp', filterOrder, cf, windowType, windowParameter);
